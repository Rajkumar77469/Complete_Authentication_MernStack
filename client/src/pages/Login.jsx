...
if(data.success){
  ...
  return (
    ...
    <p className='text-center text-sm mb-6'>{state === 'Sign Up' ? 'Create your account' : 'Login to ypour acccount!'}</p>
   ...
   <form onSubmit={onSubmitHandler}>
    ...
    {state==='Sign Up' && (    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 roundede-full bg-[#333A5C]'>
    ...
    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 roundede-full bg-[#333A5C]'>
